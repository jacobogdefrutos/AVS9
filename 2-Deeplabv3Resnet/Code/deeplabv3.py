...
def createDeepLabv3_1(inputchannels=3, outputchannels=2):
    ...
    return model
class DeepLabV3WithSoftmax(nn.Module):
    def __init__(self, inputchannels=3, outputchannels=2):
        super(DeepLabV3WithSoftmax, self).__init__()
        
        # Load the DeepLabv3 model with the ResNet101 backbone
        ...
        # Modify the last layer to have 'outputchannels' as the number of output channels
        self.model.classifier[4] = nn.Conv2d(256, outputchannels, 1)
        self.model.aux_classifier[4] = nn.Conv2d(256, outputchannels, 1)
