...
NUM_EPOCHS = 20
NUM_WORKERS = 8 
IMAGE_HEIGHT = 320 # 720 originally
IMAGE_WIDTH = 320   # 1080 originally
PIN_MEMORY = True
...
# Directories
DATA_IMG_DIR = r"/home/jacobo15defrutos/AVS9/Data/Total_noseg/Imag"
DATA_MASK_DIR = r"/home/jacobo15defrutos/AVS9/Data/Total_noseg/Labels"
...
def main():
   ...
   # set computation device and training things
    ...
    for epoch in range(loaded_epoch, NUM_EPOCHS):
        ...
        folder_val =r"/home/jacobo15defrutos/AVS9/Data/saved_val_images_unet3"
